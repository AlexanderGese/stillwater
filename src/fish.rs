...
pub static FISH: &[FishDef] = &[
    ...
    // --- Expansion: mid-tier catches (rarity 2-3) ---
    FishDef {
        id: 28,
    ...
    // --- Expansion: deep-lake rarities/legendaries (rarity 4-5) ---
    FishDef {
        id: 36,
        name: "The Old Warden",
        glyph: 'V',
    ...
    // --- Expansion: whimsical seasonal specials ---
    FishDef {
        id: 42,
        name: "Frostglow Wisp-Fish",
        glyph: 'F',
        seasons: &[Winter],
        waters: &[Marsh],
        times: &[Night],
